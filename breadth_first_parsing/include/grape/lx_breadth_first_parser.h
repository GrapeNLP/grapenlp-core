...
#ifndef GRAPE_LX_BREADTH_FIRST_PARSER_H
#define GRAPE_LX_BREADTH_FIRST_PARSER_H

#include <grape/breadth_first_parser.h>
...
namespace grape
{
	...
	{
		typedef breadth_first_parser<typename lxns_rtno<InputIterator, Id>::type::tag_input, typename lxns_rtno<InputIterator, Id>::type::tag_output, SourceRef, segment_map<SourceRef, Id, output_set_impl_choice>, serializer<segment_map<SourceRef, Id, output_set_impl_choice> >, segment_map_transformer<SourceRef, Id, output_set_impl_choice>, StateConstRefStackPool, execution_state_set_impl_choice, output_set_impl_choice> base_type;
#else
	...
	{
#ifdef TRACE
		typedef lx_breadth_first_parser<InputIterator, SourceRef, Id, array_fake_pool<typename lxns_rtno<InputIterator, Id>::type::state_const_ref>, execution_state_set_impl_choice, output_set_impl_choice> type;
#else
		typedef lx_breadth_first_parser<InputIterator, SourceRef, Id, array_fake_pool<typename lx_rtno<InputIterator, Id>::type::state_const_ref>, execution_state_set_impl_choice, output_set_impl_choice> type;
#endif
	};
	...
	{
#ifdef TRACE
		typedef lx_breadth_first_parser<InputIterator, SourceRef, Id, trie_string_pool<typename lxns_rtno<InputIterator, Id>::type::state_const_ref>, execution_state_set_impl_choice, output_set_impl_choice> type;
#else
		typedef lx_breadth_first_parser<InputIterator, SourceRef, Id, trie_string_pool<typename lx_rtno<InputIterator, Id>::type::state_const_ref>, execution_state_set_impl_choice, output_set_impl_choice> type;
#endif
	};
} //namespace grape

#endif /*GRAPE_LX_BREADTH_FIRST_PARSER_H*/
