...
#ifndef GRAPENLP_COMPRESSED_DELAF_READER_H
#define GRAPENLP_COMPRESSED_DELAF_READER_H

#include <cstdio>

#include <grapenlp/bin_delaf_reader.h>
#include <grapenlp/inf_delaf_reader.h>
...
#endif /*GRAPENLP_COMPRESSED_DELAF_READER_H*/
