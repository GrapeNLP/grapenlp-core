...
namespace grapenlp
{
	...
	bool operator==(const rb_tree_map_3w<Key, T, Compare, Allocator>& m1, const rb_tree_map_3w<Key, T, Compare, Allocator>& m2)
	...
	template<typename Key, typename T, typename Compare, typename Allocator>
	void swap(rb_tree_map_3w<Key, T, Compare, Allocator>& m1, rb_tree_map_3w<Key, T, Compare, Allocator>& m2)
    { m1.swap(m2); }
} //namespace grapenlp
