...
# CPACK_DEBIAN_PACKAGE_LICENSE - used as license indicator for the copyright file generation, possible values gpl, lgpl2_1, lpgl3, bsd, apache
...
#
#
# CPACK_COMPONENTS_ALL - list of components separated by ";" - used for the "Package" field in the control file for the package components, e.g. for development files for a library this would be "libXXX-dev"
...
# CPACK_DEBIAN_${COMPONENT}_DEPENDS - used for the "Depends" field of additional packages. ${COMPONENT} must be in the list of CPACK_COMPONENTS_ALL, e.g. dev
# CPACK_DEBIAN_${COMPONENT}_PACKAGE_SECTION - used for the "Section" field of additional packages. ${COMPONENT} must be in the list of CPACK_COMPONENTS_ALL, e.g. dev
...
set(POSSIBLE_LICENSES gpl lgpl2_1 lpgl3 bsd apache)
...
file(WRITE ${DEBIAN_RULES}
        ...
        "\n"
        # Launchpad build environment does not have variable JAVA_HOME defined, so it must be passed to cmake
        ...
        "\n"
        # Build source and documentation
        "override_dh_auto_build:\n"
        "	make -j1 -C obj-$(DEB_HOST_GNU_TYPE)\n"
        "	make -j1 -C obj-$(DEB_HOST_GNU_TYPE) doc\n"
        # Disable dh_installchangelogs
        # Changelogs are already being installed with dh_install, dh_installchangelogs would overwrite them with the
        # the dummy changelog generated by this CMake script
...
IF(${CPACK_DEBIAN_PACKAGE_NAME}-${CPACK_PACKAGE_VERSION} STREQUAL ${CPACK_SOURCE_PACKAGE_FILE_NAME})
    add_custom_command(OUTPUT ${CMAKE_BINARY_DIR}/Debian/${CPACK_DEBIAN_PACKAGE_NAME}_${CPACK_PACKAGE_VERSION}.orig.tar.gz
            ...
            COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_BINARY_DIR}/${CPACK_OUTPUT_FILE_PREFIX}/${CPACK_SOURCE_PACKAGE_FILE_NAME}.tar.gz ${CMAKE_BINARY_DIR}/Debian/${CPACK_DEBIAN_PACKAGE_NAME}_${CPACK_PACKAGE_VERSION}.orig.tar.gz
