...
#ifndef GRAPE_COMPRESSED_DELAF_ENTRY_FILTER_H
#define GRAPE_COMPRESSED_DELAF_ENTRY_FILTER_H

#include <grape/compressed_delaf.h>
#include <grape/delaf_entry_filter_type.h>
...
#endif /*GRAPE_COMPRESSED_DELAF_ENTRY_FILTER_H*/
