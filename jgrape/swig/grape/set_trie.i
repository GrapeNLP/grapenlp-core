...
{
    template<typename T>
    using set_trie_const_iterator = typename ::grape::set_trie<T>::const_iterator;
}
%}
...
namespace grape
{
    ...
    public:
        const_iterator();
        const_iterator(const trie_with_def_data_string<T, ::grape::false_func> &root): base_iterator(root);
	...
	template<typename T>
	class set_trie: public trie_with_def_data<T, ::grape::false_func, ::grape::false_func::result_type>
	{
	public:
		typedef set_trie<T> this_type;
		typedef trie_with_def_data<T, ::grape::false_func> base_trie_with_def_data;
		typedef trie_with_def_data_string<T, ::grape::false_func> string;
	...
	public:
        ...
        %rename(const_begin) ::grape::set_trie::begin() const;
        set_trie_const_iterator<T> begin() const;

        %rename(const_end) ::grape::set_trie::end() const;
