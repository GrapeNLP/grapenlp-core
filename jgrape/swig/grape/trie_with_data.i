...
namespace grape
{
    ...
    using trie_with_data_string = typename ::grape::trie_with_data<T, Data>::string;

    template<typename T, typename Data>
    using trie_with_data_const_iterator = typename ::grape::trie_with_data<T, Data>::const_iterator;
}
%}
