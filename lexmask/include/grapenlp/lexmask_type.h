...
#ifndef GRAPENLP_LEXMASK_TYPE_H
#define GRAPENLP_LEXMASK_TYPE_H
...
namespace grapenlp
{
	enum lexmask_type
	{
		...
		CASE_SENSITIVE_SUFFIX_LEXMASK,
		CASE_INSENSITIVE_SUFFIX_LEXMASK
	};
} //namespace grapenlp

#endif /*GRAPENLP_LEXMASK_TYPE_H*/
