...
#ifndef GRAPE_LRB_TREE_H
#define GRAPE_LRB_TREE_H
...
*/
	...
	private:
		inline bool compare_value_keys(const value_type &v1, const value_type &v2) const
		{ return d.comp(KeyGetter()(v1), KeyGetter()(v2)); }

		inline bool compare_value_keys(const value_type &v, base_node_const_ref x) const
		{ return d.comp(KeyGetter()(v), KeyGetter()(x->value())); }

		inline bool compare_value_keys(base_node_const_ref x, const value_type &v) const
		{ return d.comp(KeyGetter()(x->value()), KeyGetter()(v)); }

		inline bool compare_keys(const key_type &k1, const key_type &k2) const
		{ return d.comp(k1, k2); }

		inline bool compare_keys(const key_type &k, base_node_const_ref x) const
		{ return d.comp(k, KeyGetter()(x->value())); }

		inline bool compare_keys(base_node_const_ref x, const key_type &k) const
...
//				z->key() = y->key();
	...
	public:
		...
		inline bool operator== (const lrb_tree& t) const
	...
	inline void swap(lrb_tree<Key, Value, KeyGetter, KeyCompare>& x, lrb_tree<Key, Value, KeyGetter, KeyCompare>& y)
	{ x.swap(y); }

    template<typename Key, typename Value, typename KeyGetter, typename KeyCompare, typename Allocator>
    inline typename lrb_tree<Key, Value, KeyGetter, KeyCompare, Allocator>::value_type& lrb_tree<Key, Value, KeyGetter, KeyCompare, Allocator>::base_node::value()
    { return static_cast<node_ref>(this)->v; }

    template<typename Key, typename Value, typename KeyGetter, typename KeyCompare, typename Allocator>
    inline const typename lrb_tree<Key, Value, KeyGetter, KeyCompare, Allocator>::value_type& lrb_tree<Key, Value, KeyGetter, KeyCompare, Allocator>::base_node::value() const
    { return static_cast<node_const_ref>(this)->v; }
} //namespace grape

#endif /*GRAPE_LRB_TREE_H*/
