...
#ifndef GRAPE_LRB_TREE_MAP_3W_H
#define GRAPE_LRB_TREE_MAP_3W_H
...
namespace grape
{
	...
	inline bool operator==(const lrb_tree_map_3w<Key, T, Compare, Allocator>& m1, const lrb_tree_map_3w<Key, T, Compare, Allocator>& m2)
	...
	template<typename Key, typename T, typename Compare, typename Allocator>
	inline void swap(lrb_tree_map_3w<Key, T, Compare, Allocator>& m1, lrb_tree_map_3w<Key, T, Compare, Allocator>& m2)
    { m1.swap(m2); }
} //namespace grape

#endif /*GRAPE_LRB_TREE_MAP_3W_H*/
