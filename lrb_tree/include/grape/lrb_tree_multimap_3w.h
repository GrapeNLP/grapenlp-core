...
#ifndef GRAPE_LRB_TREE_MULTIMAP_3W_H
#define GRAPE_LRB_TREE_MULTIMAP_3W_H

#include <stdexcept>
#include <grape/lrb_tree_3w.h>

namespace grape
{
	template<typename Key, typename T, typename Compare = compare_3w<Key>, typename Allocator = std::allocator<std::pair<const Key, T> > >
	class lrb_tree_multimap_3w
	{
	public:
    ...
    public:
    	...
    	{
    		friend class lrb_tree_multimap_3w<Key, T, Compare, Allocator>;
    	protected:
    		Compare comp;
    ...
    public:
    	lrb_tree_multimap_3w(): the_tree()
		{}

		explicit lrb_tree_multimap_3w(const Compare& comp_, const allocator_type& alloc_ = allocator_type()): the_tree(comp_, alloc_)
		{}

		template<typename Iterator>
		lrb_tree_multimap_3w(Iterator first, Iterator last): the_tree()
		{ the_tree.multi_insert(first, last); }

		template<typename Iterator>
		lrb_tree_multimap_3w(Iterator first, Iterator last, const Compare& comp_, const allocator_type& alloc_ = allocator_type()): the_tree(comp_, alloc_)
		{ the_tree.multi_insert(first, last); }

		lrb_tree_multimap_3w(const lrb_tree_multimap_3w& s): the_tree(s.the_tree)
		{}

		lrb_tree_multimap_3w& operator=(const lrb_tree_multimap_3w& s)
		{
			the_tree = s.the_tree;
			return *this;
		}
		...
		void swap(lrb_tree_multimap_3w& m)
		...
		friend bool operator== (const lrb_tree_multimap_3w<A, B, C, D>&, const lrb_tree_multimap_3w<A, B, C, D>&);
...
#endif /*GRAPE_LRB_TREE_MULTIMAP_3W_H*/
