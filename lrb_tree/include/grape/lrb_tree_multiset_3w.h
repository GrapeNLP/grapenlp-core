...
#ifndef GRAPE_LRB_TREE_MULTISET_3W_H
#define GRAPE_LRB_TREE_MULTISET_3W_H
...
*/
    ...
    private:
    	...
    	typedef lrb_tree_3w<key_type, value_type, identity<value_type>, key_compare, key_allocator_type> lrb_tree_type;
    ...
    public:
		...
		lrb_tree_multiset_3w(): the_tree()
		{}

		explicit lrb_tree_multiset_3w(const Compare& comp_, const allocator_type& alloc_ = allocator_type()): the_tree(comp_, alloc_)
		{}

		template<typename Iterator>
		lrb_tree_multiset_3w(Iterator first, Iterator last): the_tree()
		{ the_tree.multi_insert(first, last); }

		template<typename Iterator>
		lrb_tree_multiset_3w(Iterator first, Iterator last, const Compare& comp_, const allocator_type& alloc_ = allocator_type()): the_tree(comp_, alloc_)
		{ the_tree.multi_insert(first, last); }

		lrb_tree_multiset_3w(const lrb_tree_multiset_3w& s): the_tree(s.the_tree)
		{}

		lrb_tree_multiset_3w& operator=(const lrb_tree_multiset_3w& s)
		{
			the_tree = s.the_tree;
			return *this;
		}
		...
		void swap(lrb_tree_multiset_3w& s)
		...
		friend bool operator== (const lrb_tree_multiset_3w<A, B, C>&, const lrb_tree_multiset_3w<A, B, C>&);
...
#endif /*GRAPE_LRB_TREE_MULTISET_3W_H*/
