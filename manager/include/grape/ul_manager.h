...
#ifndef GRAPE_UL_MANAGER_H
#define GRAPE_UL_MANAGER_H
...
#include <grape/disable_directives.h>
...
#include <grape/ulua_fst2_reader.h>
#endif
#ifndef DISABLE_LUAW_GRAMMAR
#include <grape/uluaw_fst2_reader.h>
#endif
#ifndef DISABLE_LUX_GRAMMAR
#include <grape/ulx_fst2_reader.h>
#endif
...
#include <grape/lw_rtno_weight_tagger.h>
#include <grape/weight_transformer_traits.h> //XXXX

#endif

//FPRTNs
#ifndef DISABLE_LUA_GRAMMAR
#include <grape/lua_output_fprtn.h>
#include <grape/lua_output_fprtn_zpps.h>
#endif
#ifndef DISABLE_LUAW_GRAMMAR
#include <grape/luaw_output_fprtn.h>
#include <grape/luaw_output_fprtn_zpps.h>
#include <grape/luaw_output_fprtn_top.h>
#endif
#ifndef DISABLE_LUX_GRAMMAR
#include <grape/lux_output_fprtn.h>
#include <grape/lux_output_fprtn_zpps.h>
#endif
#ifndef DISABLE_LUXW_GRAMMARS

#include <grape/luxw_output_fprtn.h>
#include <grape/luxw_output_fprtn_zpps.h>
#include <grape/luxw_output_fprtn_top.h>
...
#include <grape/lua_depth_first_parser.h>
#include <grape/luaw_depth_first_parser.h>
#include <grape/lx_depth_first_parser.h>
#include <grape/lxw_depth_first_parser.h>
#endif
#ifndef DISABLE_PARSERS_WITHOUT_OUTPUT
#include <grape/lua_depth_first_parser_no_output.h>
#include <grape/luaw_depth_first_parser_no_output.h>
#include <grape/lx_depth_first_parser_no_output.h>
#include <grape/lxw_depth_first_parser_no_output.h>
#endif
#endif //DISABLE_DEPTH_FIRST_PARSER

#ifndef DISABLE_BREADTH_FIRST_PARSER
#ifndef DISABLE_PARSERS_WITH_OUTPUT
#include <grape/lua_breadth_first_parser.h>
#include <grape/luaw_breadth_first_parser.h>
#include <grape/lx_breadth_first_parser.h>
#include <grape/lxw_breadth_first_parser.h>
#endif
#ifndef DISABLE_PARSERS_WITHOUT_OUTPUT
#include <grape/lua_breadth_first_parser_no_output.h>
#include <grape/luaw_breadth_first_parser_no_output.h>
#include <grape/lx_breadth_first_parser_no_output.h>
#include <grape/lxw_breadth_first_parser_no_output.h>
#endif
#endif //DISABLE_BREADTH_FIRST_PARSER

#ifndef DISABLE_EARLEY_PARSER
#ifndef DISABLE_PARSERS_WITH_OUTPUT
#include <grape/lua_earley_parser.h>
#include <grape/luaw_earley_parser.h>
#include <grape/lx_earley_parser.h>
#include <grape/lxw_earley_parser.h>
#endif
#ifndef DISABLE_PARSERS_WITHOUT_OUTPUT
#include <grape/lua_earley_parser_no_output.h>
#include <grape/luaw_earley_parser_no_output.h>
#include <grape/lx_earley_parser_no_output.h>
#include <grape/lxw_earley_parser_no_output.h>
#endif
#endif //DISABLE_EARLEY_PARSER

#ifndef DISABLE_TO_FPRTN_PLAIN_PARSERS
#include <grape/lua_to_fprtn_parser.h>
#include <grape/luaw_to_fprtn_parser.h>
#include <grape/lx_to_fprtn_parser.h>
#include <grape/lxw_to_fprtn_parser.h>
#include <grape/output_fprtn_prune.h>
#endif

#ifndef DISABLE_TO_FPRTN_ZPPS_PARSERS
#include <grape/lua_to_fprtn_zpps_parser.h>
#include <grape/lua_output_fprtn_zpps_prune.h>
#include <grape/luaw_to_fprtn_zpps_parser.h>
#include <grape/luaw_output_fprtn_zpps_prune.h>
#include <grape/lx_to_fprtn_zpps_parser.h>
#include <grape/lux_output_fprtn_zpps_prune.h>
#include <grape/lxw_to_fprtn_zpps_parser.h>
#include <grape/luxw_output_fprtn_zpps_prune.h>
#endif

#ifndef DISABLE_TO_FPRTN_TOP_PARSERS

#include <grape/lua_to_fprtn_top_parser.h>
#include <grape/luaw_to_fprtn_top_parser.h>
#include <grape/luaw_output_fprtn_top_prune.h>
#include <grape/lx_to_fprtn_top_parser.h>
#include <grape/lxw_to_fprtn_top_parser.h>
#include <grape/luxw_output_fprtn_top_prune.h>

#endif

#ifndef DISABLE_TO_FPRTN_PARSER_AND_BREADTH_FIRST_EXPANDER
#include <grape/lua_fprtn_breadth_first_expander.h>
#include <grape/luaw_fprtn_breadth_first_expander.h>
#include <grape/lux_fprtn_breadth_first_expander.h>
#include <grape/luxw_fprtn_breadth_first_expander.h>
#endif

#ifndef DISABLE_TO_FPRTN_PARSER_AND_BLACKBOARD_SET_EXPANDER
#include <grape/lua_fprtn_blackboard_set_expander.h>
#include <grape/lua_output_fprtn_zpps_prune.h>
#include <grape/luaw_fprtn_blackboard_set_expander.h>
#include <grape/luaw_output_fprtn_zpps_prune.h>
#include <grape/lux_fprtn_blackboard_set_expander.h>
#include <grape/lux_output_fprtn_zpps_prune.h>
#include <grape/luxw_fprtn_blackboard_set_expander.h>
#include <grape/luxw_output_fprtn_zpps_prune.h>
#endif

#ifndef DISABLE_TO_FPRTN_PARSER_AND_TOP_BLACKBOARD_EXTRACTOR

#include <grape/luaw_fprtn_top_blackboard_extractor.h>
#include <grape/luaw_output_fprtn_top_prune.h>
#include <grape/luxw_fprtn_top_blackboard_extractor.h>
#include <grape/luxw_output_fprtn_top_prune.h>
...
#include <grape/simple_segment_array_x_weight.h>
...
#include <grape/movistarbot_out_serializer.h>
#endif
#ifndef DISABLE_WEIGHTED_GRAMMARS
...
#ifndef DISABLE_TEXT_DICO
#include <grape/to_canonical_form.h>
#endif
#ifndef DISABLE_COMPRESSED_DICO
...
#include <grape/u_manager_constants.h>
    ...
    public:
        ...
        std::size_t tokenize(InputIterator input_begin, InputIterator input_end) {
            ...
            if (input_begin != input_end) {
                grape::tokenize(input_begin, input_end, the_token_list);
