...
#ifndef GRAPE_LUXW_OUTPUT_FPRTN_H
#define GRAPE_LUXW_OUTPUT_FPRTN_H

#include <grape/lexmask.h>
#include <grape/uxw_output_fprtn.h>
...
namespace grape
{
	...
	{
		typedef typename uxw_output_fprtn<SourceRef, Weight, typename lexmask<InputIterator>::const_ref, execution_state_set_impl_choice, edc, StateMappedExtraData>::type type;
...
#endif /*GRAPE_LUXW_OUTPUT_FPRTN_H*/
