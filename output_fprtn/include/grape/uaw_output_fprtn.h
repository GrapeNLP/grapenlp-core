...
#ifndef GRAPE_UAW_OUTPUT_FPRTN_H
#define GRAPE_UAW_OUTPUT_FPRTN_H

#include <grape/u_array_const_ref_x_weight.h>
#include <grape/aw_output_fprtn.h>
...
namespace grape
{
	...
	{
		typedef typename aw_output_fprtn<SourceRef, unichar, Weight, RTNOTagInput, execution_state_set_impl_choice, edc, StateMappedExtraData>::type type;
...
#endif /*GRAPE_UAW_OUTPUT_FPRTN_H*/
