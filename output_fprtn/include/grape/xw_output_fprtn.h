...
#ifndef GRAPE_XW_OUTPUT_FPRTN_H
#define GRAPE_XW_OUTPUT_FPRTN_H
...
namespace grape
{
	...
	{
		typedef output_fprtn<SourceRef, out_bound_const_ref_x_weight<Id, Weight>, RTNOTagInput, execution_state_set_impl_choice, edc, StateMappedExtraData> type;
