...
#ifndef GRAPE_LUAW_FPRTN_BLACKBOARD_SET_EXPANDER_H
#define GRAPE_LUAW_FPRTN_BLACKBOARD_SET_EXPANDER_H

#include <grape/lexmask.h>
#include <grape/uaw_fprtn_blackboard_set_expander.h>
...
#endif /*GRAPE_LUAW_WFPRTN_BLACKBOARD_SET_EXPANDER_H*/
