...
#ifndef GRAPE_A_FPRTN_BREADTH_FIRST_EXPANDER_H
#define GRAPE_A_FPRTN_BREADTH_FIRST_EXPANDER_H

#ifdef TRACE
#include <grape/iostream.h>
#endif

#include <grape/a_output_fprtn.h>
#include <grape/fprtn_breadth_first_expander.h>
...
namespace grape
{
	...
	{
#ifdef TRACE
		typedef a_fprtn_breadth_first_expander<SourceRef, RTNOTagInput, array_fake_ref_pool<typename a_output_fprtn<SourceRef, OutputChar, RTNOTagInput, execution_state_set_impl_choice>::type::state_const_ref>, array_fake_pool<OutputChar>, serializer<typename array_fake_pool<OutputChar>::value_type>, execution_state_set_impl_choice, output_set_impl_choice> type;
#else
		typedef a_fprtn_breadth_first_expander<SourceRef, RTNOTagInput, array_fake_ref_pool<typename a_output_fprtn<SourceRef, OutputChar, RTNOTagInput, execution_state_set_impl_choice>::type::state_const_ref>, array_fake_pool<OutputChar>, execution_state_set_impl_choice, output_set_impl_choice> type;
#endif
	};
	...
	{
#ifdef TRACE
		typedef a_fprtn_breadth_first_expander<SourceRef, RTNOTagInput, trie_string_ref_pool<typename a_output_fprtn<SourceRef, OutputChar, RTNOTagInput, execution_state_set_impl_choice>::type::state_const_ref>, trie_string_ref_pool<OutputChar>, const_deref_serializer<typename trie_string_ref_pool<OutputChar>::base_type>, execution_state_set_impl_choice, output_set_impl_choice> type;
#else
		typedef a_fprtn_breadth_first_expander<SourceRef, RTNOTagInput, trie_string_ref_pool<typename a_output_fprtn<SourceRef, OutputChar, RTNOTagInput, execution_state_set_impl_choice>::type::state_const_ref>, trie_string_ref_pool<OutputChar>, execution_state_set_impl_choice, output_set_impl_choice> type;
#endif
	};
}

#endif /*GRAPE_A_WFPRTN_BREADTH_FIRST_EXPANDER_H*/
