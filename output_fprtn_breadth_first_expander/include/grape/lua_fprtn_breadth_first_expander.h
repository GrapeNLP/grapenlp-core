...
#ifndef GRAPE_LUA_FPRTN_BREADTH_FIRST_EXPANDER_H
#define GRAPE_LUA_FPRTN_BREADTH_FIRST_EXPANDER_H

#include <grape/lexmask.h>
#include <grape/ua_fprtn_breadth_first_expander.h>
...
#endif /*GRAPE_LUA_WFPRTN_BREADTH_FIRST_EXPANDER_H*/
