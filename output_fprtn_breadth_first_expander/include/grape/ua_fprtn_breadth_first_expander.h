...
#ifndef GRAPE_UA_FPRTN_BREADTH_FIRST_EXPANDER_H
#define GRAPE_UA_FPRTN_BREADTH_FIRST_EXPANDER_H

#include <grape/lexmask.h>
#include <grape/a_fprtn_breadth_first_expander.h>
...
#endif /*GRAPE_UA_WFPRTN_BREADTH_FIRST_EXPANDER_H*/
