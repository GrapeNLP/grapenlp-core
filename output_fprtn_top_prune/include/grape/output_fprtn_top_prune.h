...
#ifndef GRAPE_OUTPUT_FPRTN_TOP_PRUNE_H
#define GRAPE_OUTPUT_FPRTN_TOP_PRUNE_H

#include <grape/output_fprtn_top.h>
...
namespace grape
{
	...
	void mark_unreachable_states_top(typename output_fprtn_top<SourceRef, TagInput, RTNOTagInput, execution_state_set_impl_choice>::type &m, typename weighted_tag_output_traits<typename output_fprtn_top<SourceRef, TagInput, RTNOTagInput, execution_state_set_impl_choice>::type::tag_input>::weight w_min)
	{
		typedef typename output_fprtn_top<SourceRef, TagInput, RTNOTagInput, execution_state_set_impl_choice>::type machine;
	...
	template<typename SourceRef, typename TagInput, typename RTNOTagInput, assoc_container_impl_choice execution_state_set_impl_choice>
	bool prune_top(typename output_fprtn_top<SourceRef, TagInput, RTNOTagInput, execution_state_set_impl_choice>::type &m, typename weighted_tag_output_traits<TagInput>::weight w_min)
	{
#ifdef TRACE
...
#endif /*GRAPE_OUTPUT_FPRTN_TOP_PRUNE_H*/
