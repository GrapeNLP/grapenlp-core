...
#ifndef GRAPE_LUA_OUTPUT_FPRTN_ZPPS_PRUNE_H
#define GRAPE_LUA_OUTPUT_FPRTN_ZPPS_PRUNE_H

#include <grape/ua_output_fprtn_zpps_prune.h>
...
#endif /*GRAPE_LUA_OUTPUT_FPRTN_ZPPS_PRUNE_H*/
