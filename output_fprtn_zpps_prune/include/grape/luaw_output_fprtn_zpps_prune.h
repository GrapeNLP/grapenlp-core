...
#ifndef GRAPE_LUAW_OUTPUT_FPRTN_ZPPS_PRUNE_H
#define GRAPE_LUAW_OUTPUT_FPRTN_ZPPS_PRUNE_H

#include <grape/uaw_output_fprtn_zpps_prune.h>
...
#endif /*GRAPE_LUAW_OUTPUT_FPRTN_ZPPS_PRUNE_H*/
