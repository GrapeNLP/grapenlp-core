...
#ifndef GRAPE_UX_OUTPUT_FPRTN_ZPPS_PRUNE_H
#define GRAPE_UX_OUTPUT_FPRTN_ZPPS_PRUNE_H

#include <grape/x_output_fprtn_zpps_prune.h>
...
#endif /*GRAPE_UX_OUTPUT_FPRTN_ZPPS_PRUNE_H*/
