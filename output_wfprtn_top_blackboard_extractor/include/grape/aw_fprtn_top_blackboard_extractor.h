...
#ifndef GRAPE_AW_FPRTN_TOP_BLACKBOARD_EXTRACTOR_H
#define GRAPE_AW_FPRTN_TOP_BLACKBOARD_EXTRACTOR_H
...
#endif /*GRAPE_AW_WFPRTN_TOP_BLACKBOARD_EXTRACTOR_H*/
