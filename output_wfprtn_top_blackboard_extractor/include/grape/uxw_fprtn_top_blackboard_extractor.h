...
#ifndef GRAPE_UXW_FPRTN_TOP_BLACKBOARD_EXTRACTOR_H
#define GRAPE_UXW_FPRTN_TOP_BLACKBOARD_EXTRACTOR_H

#include <grape/lexmask.h>
#include <grape/xw_fprtn_top_blackboard_extractor.h>
...
#endif /*GRAPE_UXW_WFPRTN_TOP_BLACKBOARD_EXTRACTOR_H*/
