...
namespace grape
{
    ...
    using trie_with_def_data_string = typename ::grape::trie_with_def_data<T, DefDataValueGetter, Data>::string;

    template<typename T, typename DefDataValueGetter, typename Data = typename DefDataValueGetter::result_type>
    using trie_with_def_data_const_iterator = typename ::grape::trie_with_def_data<T, DefDataValueGetter, Data>::const_iterator;
}
%}
