...
%{
/*#include <grape/ualxiw_manager.h>*/
#include <grape/ul_manager.h>
namespace grape
{
    typedef typename u_array::const_iterator ua_input_iterator;
    typedef ::grape::ul_manager<ua_input_iterator, std::plus<int> > ualxiw_manager;
}
%}

namespace grape
{
    typedef ::grape::u_array::const_iterator ua_input_iterator;
    ...
    public:
        ...
        const ::grape::uaui_simple_segment_array_x_weight_array& get_simplified_weighted_output();
/*        const ::grape::simple_segment_array_x_weight_array<InputIterator, unichar, weight>& get_simplified_weighted_output();*/
...
/*        const u_array& get_output_u_array();*/
    ...
    typedef ::grape::ul_manager<ua_input_iterator, std::plus<int> > ualxiw_manager;
    %template(ualxiw_manager) ::grape::ul_manager<::grape::u_array::const_iterator, std::plus<int> >;
}
