...
#ifndef GRAPE_RB_TREE_MAP_H
#define GRAPE_RB_TREE_MAP_H
...
namespace grape
{
	...
	inline bool operator==(const rb_tree_map<Key, T, Compare, Allocator>& m1, const rb_tree_map<Key, T, Compare, Allocator>& m2)
	...
	template<typename Key, typename T, typename Compare, typename Allocator>
	inline void swap(rb_tree_map<Key, T, Compare, Allocator>& m1, rb_tree_map<Key, T, Compare, Allocator>& m2)
    { m1.swap(m2); }
} //namespace grape

#endif /*GRAPE_RB_TREE_MAP_H*/
