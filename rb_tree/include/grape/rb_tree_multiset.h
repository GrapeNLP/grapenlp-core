...
#ifndef GRAPE_RB_TREE_MULTISET_H
#define GRAPE_RB_TREE_MULTISET_H
...
*/
	...
	inline bool operator==(const rb_tree_multiset<Key, Compare, Allocator>& s1, const rb_tree_multiset<Key, Compare, Allocator>& s2)
	...
	template<typename Key, typename Compare, typename Allocator>
	inline void swap(rb_tree_multiset<Key, Compare, Allocator>& s1, rb_tree_multiset<Key, Compare, Allocator>& s2)
    { s1.swap(s2); }
} //namespace grape

#endif /*GRAPE_RB_TREE_MULTISET_H*/
