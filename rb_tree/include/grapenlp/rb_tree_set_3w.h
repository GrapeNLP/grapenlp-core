...
#ifndef GRAPENLP_RB_TREE_SET_3W_H
#define GRAPENLP_RB_TREE_SET_3W_H
...
*/
    ...
    public:
		...
		rb_tree_set_3w(): the_tree()
		{}

		explicit rb_tree_set_3w(const Compare& comp_, const allocator_type& alloc_ = allocator_type()): the_tree(comp_, alloc_)
		{}

		template<typename Iterator>
		rb_tree_set_3w(Iterator first, Iterator last): the_tree()
		{ the_tree.insert(first, last); }

		template<typename Iterator>
		rb_tree_set_3w(Iterator first, Iterator last, const Compare& comp_, const allocator_type& alloc_ = allocator_type()): the_tree(comp_, alloc_)
		{ the_tree.insert(first, last); }

		rb_tree_set_3w(const rb_tree_set_3w& s): the_tree(s.the_tree)
		{}

		rb_tree_set_3w& operator=(const rb_tree_set_3w& s)
		{
			the_tree = s.the_tree;
			return *this;
		}
		...
		friend bool operator== (const rb_tree_set_3w<A, B, C>&, const rb_tree_set_3w<A, B, C>&);
	...
	inline bool operator==(const rb_tree_set_3w<Key, Compare, Allocator>& s1, const rb_tree_set_3w<Key, Compare, Allocator>& s2)
	...
	template<typename Key, typename Compare, typename Allocator>
	inline void swap(rb_tree_set_3w<Key, Compare, Allocator>& s1, rb_tree_set_3w<Key, Compare, Allocator>& s2)
    { s1.swap(s2); }
} //namespace grapenlp

#endif /*GRAPENLP_RB_TREE_SET_3W_H*/
