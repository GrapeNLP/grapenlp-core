...
#ifndef GRAPE_RTNO_TO_DOT_SERIALIZER_H
#define GRAPE_RTNO_TO_DOT_SERIALIZER_H
#include <ostream>
#include <string>
...
namespace grape
{
	template<typename TagInputSerializer, typename TagOutputSerializer>
	struct rtno_to_dot_serializer
	{
		...
		typedef ns_rtno<tag_input, tag_output> elem_type;
	...
	public:
		rtno_to_dot_serializer(): tis(), tos()
		{}
...
#endif /*GRAPE_RTNO_TO_DOT_SERIALIZER_H*/
