...
{
#ifdef TRACE
	template<typename InputIterator, typename SourceRef, typename ContextKey, typename ContextValue, typename Id, typename WeightTransformer, typename StateConstRefStackPool, assoc_container_impl_choice output_set_impl_choice>
	...
	struct lxw_depth_first_parser: public depth_first_parser<
	        typename lxw_rtno<InputIterator, Id, typename WeightTransformer::result_type>::type::tag_input,
	        typename lxw_rtno<InputIterator, Id, typename WeightTransformer::result_type>::type::tag_output,
	        SourceRef,
	        ContextKey,
	        ContextValue,
	        segment_map_x_weight<SourceRef, Id, typename WeightTransformer::result_type, output_set_impl_choice>,
	...
	template<typename InputIterator, typename SourceRef, typename ContextKey, typename ContextValue, typename Id, typename WeightTransformer, sequence_impl_choice sic, assoc_container_impl_choice output_set_impl_choice>
	struct lxw_depth_first_parser_impl_selector
	{};

	template<typename InputIterator, typename SourceRef, typename ContextKey, typename ContextValue, typename Id, typename WeightTransformer, assoc_container_impl_choice output_set_impl_choice>
	struct lxw_depth_first_parser_impl_selector<InputIterator, SourceRef, ContextKey, ContextValue, Id, WeightTransformer, ARRAYS, output_set_impl_choice>
	{
#ifdef TRACE
		typedef lxw_depth_first_parser<InputIterator, SourceRef, ContextKey, ContextValue, Id, WeightTransformer, array_fake_pool<typename lxwns_rtno<InputIterator, Id, typename WeightTransformer::result_type, typename context<ContextKey, ContextValue>::optimized_context_key, typename context<ContextKey, ContextValue>::optimized_context_value>::type::state_const_ref>, output_set_impl_choice> type;
#else
		typedef lxw_depth_first_parser<InputIterator, SourceRef, ContextKey, ContextValue, Id, WeightTransformer, array_fake_pool<typename lxw_rtno<InputIterator, Id, typename WeightTransformer::result_type, typename context<ContextKey, ContextValue>::optimized_context_key, typename context<ContextKey, ContextValue>::optimized_context_value>::type::state_const_ref>, output_set_impl_choice> type;
#endif
	};

	template<typename InputIterator, typename SourceRef, typename ContextKey, typename ContextValue, typename Id, typename WeightTransformer, assoc_container_impl_choice output_set_impl_choice>
	struct lxw_depth_first_parser_impl_selector<InputIterator, SourceRef, ContextKey, ContextValue, Id, WeightTransformer, TRIE_STRINGS, output_set_impl_choice>
	{
#ifdef TRACE
		typedef lxw_depth_first_parser<InputIterator, SourceRef, ContextKey, ContextValue, Id, WeightTransformer, trie_string_pool<typename lxwns_rtno<InputIterator, Id, typename WeightTransformer::result_type, typename context<ContextKey, ContextValue>::optimized_context_key, typename context<ContextKey, ContextValue>::optimized_context_value>::type::state_const_ref>, output_set_impl_choice> type;
#else
		typedef lxw_depth_first_parser<InputIterator, SourceRef, ContextKey, ContextValue, Id, WeightTransformer, trie_string_pool<typename lxw_rtno<InputIterator, Id, typename WeightTransformer::result_type, typename context<ContextKey, ContextValue>::optimized_context_key, typename context<ContextKey, ContextValue>::optimized_context_value>::type::state_const_ref>, output_set_impl_choice> type;
#endif
	};
} //namespace grapenlp
