...
namespace grapenlp
{
	...
	bool operator==(const lrb_tree_map<Key, T, Compare, Allocator>& m1, const lrb_tree_map<Key, T, Compare, Allocator>& m2)
	...
	template<typename Key, typename T, typename Compare, typename Allocator>
	void swap(lrb_tree_map<Key, T, Compare, Allocator>& m1, lrb_tree_map<Key, T, Compare, Allocator>& m2)
    { m1.swap(m2); }
} //namespace grapenlp
