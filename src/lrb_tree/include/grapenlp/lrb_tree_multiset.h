...
*/
	...
	bool operator==(const lrb_tree_multiset<Key, Compare, Allocator>& s1, const lrb_tree_multiset<Key, Compare, Allocator>& s2)
	...
	template<typename Key, typename Compare, typename Allocator>
	void swap(lrb_tree_multiset<Key, Compare, Allocator>& s1, lrb_tree_multiset<Key, Compare, Allocator>& s2)
    { s1.swap(s2); }
} //namespace grapenlp
