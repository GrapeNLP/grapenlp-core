...
namespace grapenlp
{
	...
	{
		typedef output_fprtn<ContextKey, ContextValue, SourceRef, array_const_ref_x_weight<T, Weight>, RTNOTagInput, execution_state_set_impl_choice, edc, StateMappedExtraData> type;
