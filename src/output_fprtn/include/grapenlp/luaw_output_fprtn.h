...
#ifndef GRAPENLP_LUAW_OUTPUT_FPRTN_H
#define GRAPENLP_LUAW_OUTPUT_FPRTN_H
...
namespace grapenlp
{
	...
	{
		typedef typename uaw_output_fprtn<ContextKey, ContextValue, SourceRef, Weight, typename lexmask<InputIterator>::const_ref, execution_state_set_impl_choice, edc, StateMappedExtraData>::type type;
...
#endif /*GRAPENLP_LUAW_OUTPUT_FPRTN_H*/
