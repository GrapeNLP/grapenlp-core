...
namespace grapenlp
{
	...
	using lux_output_fprtn = ux_output_fprtn<ContextMask, SourceRef, typename lexmask<InputIterator>::const_ref, execution_state_set_impl_choice, edc, StateMappedExtraData>;
} //namespace grapenlp
