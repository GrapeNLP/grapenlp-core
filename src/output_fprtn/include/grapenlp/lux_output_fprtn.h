...
namespace grapenlp
{
	...
	{
		typedef typename ux_output_fprtn<ContextMask, SourceRef, typename lexmask<InputIterator>::const_ref, execution_state_set_impl_choice, edc, StateMappedExtraData>::type type;
