...
namespace grapenlp
{
	...
	{
		typedef typename a_output_fprtn<ContextKey, ContextValue, SourceRef, unichar, RTNOTagInput, execution_state_set_impl_choice, edc, StateMappedExtraData>::type type;
