...
#ifndef GRAPENLP_UXW_OUTPUT_FPRTN_H
#define GRAPENLP_UXW_OUTPUT_FPRTN_H
...
namespace grapenlp
{
	...
	{
		typedef typename xw_output_fprtn<ContextKey, ContextValue, SourceRef, unichar, Weight, RTNOTagInput, execution_state_set_impl_choice, edc, StateMappedExtraData>::type type;
