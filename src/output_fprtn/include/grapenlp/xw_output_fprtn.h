...
namespace grapenlp
{
	...
	{
		typedef output_fprtn<ContextMask, SourceRef, out_bound_const_ref_x_weight<Id, Weight>, RTNOTagInput, execution_state_set_impl_choice, edc, StateMappedExtraData> type;
