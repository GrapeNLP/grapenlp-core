...
namespace grapenlp
{
	...
	struct a_fprtn_blackboard_set_expander: public fprtn_blackboard_set_expander<
        SourceRef,
        typename a_output_fprtn_zpps<u_context_mask, SourceRef, typename OutputArrayPool::char_type, RTNOTagInput, execution_state_set_impl_choice>::tag_input,
        RTNOTagInput,
        typename OutputArrayPool::value_type,
        OutputArraySerializer,
        typename OutputArrayPool::concatenator, typename OutputArrayPool::concatenator2,
        execution_state_set_impl_choice,
        output_set_impl_choice
        >
	{
		typedef fprtn_blackboard_set_expander<SourceRef, typename a_output_fprtn_zpps<u_context_mask, SourceRef, typename OutputArrayPool::char_type, RTNOTagInput, execution_state_set_impl_choice>::tag_input, RTNOTagInput, typename OutputArrayPool::value_type, OutputArraySerializer, typename OutputArrayPool::concatenator, typename OutputArrayPool::concatenator2, execution_state_set_impl_choice, output_set_impl_choice> base_type;
#else
	...
	struct a_fprtn_blackboard_set_expander: public fprtn_blackboard_set_expander<
        ...
        typename OutputArrayPool::concatenator2,
        execution_state_set_impl_choice,
        output_set_impl_choice
        >
	{
