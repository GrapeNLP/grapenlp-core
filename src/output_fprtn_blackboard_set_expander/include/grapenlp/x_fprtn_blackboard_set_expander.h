...
#ifndef GRAPENLP_X_FPRTN_BLACKBOARD_SET_EXPANDER_H
#define GRAPENLP_X_FPRTN_BLACKBOARD_SET_EXPANDER_H

#include <grapenlp/segment.h>
#include <grapenlp/x_output_fprtn_zpps.h>
...
#endif /*GRAPENLP_X_WFPRTN_BLACKBOARD_SET_EXPANDER_H*/
