...
#ifdef TRACE
	struct x_fprtn_blackboard_set_expander: public fprtn_blackboard_set_expander<
        SourceRef,
        typename x_output_fprtn_zpps<u_context_mask, SourceRef, Id, RTNOTagInput, execution_state_set_impl_choice>::tag_input,
        RTNOTagInput,
        ...
        segment_map_composer<SourceRef, Id, output_set_impl_choice>,
