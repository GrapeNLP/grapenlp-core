...
namespace grapenlp
{
	...
	struct aw_fprtn_breadth_first_expander: public fprtn_breadth_first_expander<
        SourceRef,
        typename aw_output_fprtn<u_context_mask, SourceRef, typename OutputArrayPool::char_type, typename WeightTransformer::result_type, RTNOTagInput, execution_state_set_impl_choice>::tag_input,
        RTNOTagInput,
	...
	{
#ifdef TRACE
		typedef aw_fprtn_breadth_first_expander<SourceRef, WeightTransformer, RTNOTagInput, trie_string_ref_pool<typename aw_output_fprtn<u_context_mask, SourceRef, OutputChar, typename WeightTransformer::result_type, RTNOTagInput, execution_state_set_impl_choice>::state_const_ref>, trie_string_ref_pool<OutputChar>, const_deref_serializer<typename trie_string_ref_pool<OutputChar>::base_type>, execution_state_set_impl_choice, output_set_impl_choice> type;
#else
		typedef aw_fprtn_breadth_first_expander<SourceRef, WeightTransformer, RTNOTagInput, trie_string_ref_pool<typename aw_output_fprtn<u_context_mask, SourceRef, OutputChar, typename WeightTransformer::result_type, RTNOTagInput, execution_state_set_impl_choice>::state_const_ref>, trie_string_ref_pool<OutputChar>, execution_state_set_impl_choice, output_set_impl_choice> type;
#endif
	};
}
