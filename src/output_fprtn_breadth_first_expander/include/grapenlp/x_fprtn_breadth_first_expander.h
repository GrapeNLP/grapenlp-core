...
namespace grapenlp
{
...
#ifdef TRACE
	struct x_fprtn_breadth_first_expander: public fprtn_breadth_first_expander<
        SourceRef,
        typename x_output_fprtn<u_context_mask, SourceRef, Id, RTNOTagInput, execution_state_set_impl_choice>::tag_input,
        RTNOTagInput,
	...
	struct x_fprtn_breadth_first_expander: public fprtn_breadth_first_expander<
        SourceRef,
        typename x_output_fprtn<u_context_mask, SourceRef, Id, RTNOTagInput, execution_state_set_impl_choice>::tag_input,
        RTNOTagInput, segment_map<SourceRef, Id, output_set_impl_choice>,
        segment_map_transformer<SourceRef, Id, output_set_impl_choice>,
        StateConstRefStackPool,
	...
	{
		typedef x_fprtn_breadth_first_expander<SourceRef, Id, RTNOTagInput, array_fake_ref_pool<typename x_output_fprtn<u_context_mask, SourceRef, Id, RTNOTagInput, execution_state_set_impl_choice>::state_const_ref>, execution_state_set_impl_choice, output_set_impl_choice> type;
	};
	...
	{
		typedef x_fprtn_breadth_first_expander<SourceRef, Id, RTNOTagInput, trie_string_ref_pool<typename x_output_fprtn<u_context_mask, SourceRef, Id, RTNOTagInput, execution_state_set_impl_choice>::state_const_ref>, execution_state_set_impl_choice, output_set_impl_choice> type;
	};
}
