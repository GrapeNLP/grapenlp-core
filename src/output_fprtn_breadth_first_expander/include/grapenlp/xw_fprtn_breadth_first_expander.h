...
namespace grapenlp
{
...
#ifdef TRACE
	struct xw_fprtn_breadth_first_expander: public fprtn_breadth_first_expander<
        SourceRef,
        typename xw_output_fprtn<u_context_mask, SourceRef, Id, typename WeightTransformer::result_type, RTNOTagInput, execution_state_set_impl_choice>::tag_input,
        RTNOTagInput,
	...
	struct xw_fprtn_breadth_first_expander: public fprtn_breadth_first_expander<
        SourceRef,
        typename xw_output_fprtn<u_context_mask, SourceRef, Id, typename WeightTransformer::result_type,
        RTNOTagInput,
        execution_state_set_impl_choice>::tag_input,
        RTNOTagInput,
        segment_map_x_weight<SourceRef, Id, typename WeightTransformer::result_type, output_set_impl_choice>,
        segment_map_x_weight_transformer<SourceRef, Id, WeightTransformer, output_set_impl_choice>,
        StateConstRefStackRefPool,
	...
	{
		typedef xw_fprtn_breadth_first_expander<SourceRef, Id, WeightTransformer, RTNOTagInput, trie_string_ref_pool<typename xw_output_fprtn<u_context_mask, SourceRef, Id, typename WeightTransformer::result_type, RTNOTagInput, execution_state_set_impl_choice>::state_const_ref>, execution_state_set_impl_choice, output_set_impl_choice> type;
	};
}
