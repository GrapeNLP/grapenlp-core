...
//			out << "node [shape = ellipse];" << std::endl;
	...
	{ return inv_output_fprtn_to_dot_serializer<ContextMask, SourceRef, typename tag_serializer_traits<TagInput>::type, RTNOTagInput, execution_state_set_impl_choice, edc, StateMappedExtraData>()(out, output_fprtn_name, the_output_fprtn); }
