...
namespace grapenlp
{
	...
	std::size_t xw_prune_top(typename xw_output_fprtn_top<u_context_mask, SourceRef, Id, Weight, RTNOTagInput, execution_state_set_impl_choice>::type &m, Weight w_min)
	{
