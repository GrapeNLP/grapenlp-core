...
#ifndef GRAPENLP_RB_TREE_MULTIMAP_3W_H
#define GRAPENLP_RB_TREE_MULTIMAP_3W_H

#include <stdexcept>
#include <grapenlp/rb_tree_3w.h>

namespace grapenlp
{
	template<typename Key, typename T, typename Compare = compare_3w<Key>, typename Allocator = std::allocator<std::pair<const Key, T> > >
	class rb_tree_multimap_3w
	{
	public:
    ...
    public:
    	...
    	{
    		friend class rb_tree_multimap_3w<Key, T, Compare, Allocator>;
    	protected:
    		Compare comp;
    ...
    private:
		...
		typedef rb_tree_3w<key_type, value_type, pair_first<Key, T>, key_compare, value_allocator_type> rb_tree_type;
    ...
    public:
    	rb_tree_multimap_3w(): the_tree()
		{}

		explicit rb_tree_multimap_3w(const Compare& comp_, const allocator_type& alloc_ = allocator_type()): the_tree(comp_, alloc_)
		{}

		template<typename Iterator>
		rb_tree_multimap_3w(Iterator first, Iterator last): the_tree()
		{ the_tree.multi_insert(first, last); }

		template<typename Iterator>
		rb_tree_multimap_3w(Iterator first, Iterator last, const Compare& comp_, const allocator_type& alloc_ = allocator_type()): the_tree(comp_, alloc_)
		{ the_tree.multi_insert(first, last); }

		rb_tree_multimap_3w(const rb_tree_multimap_3w& s): the_tree(s.the_tree)
		{}

		rb_tree_multimap_3w& operator=(const rb_tree_multimap_3w& s)
		{
			the_tree = s.the_tree;
			return *this;
		}
		...
		void swap(rb_tree_multimap_3w& m)
		...
		friend bool operator== (const rb_tree_multimap_3w<A, B, C, D>&, const rb_tree_multimap_3w<A, B, C, D>&);
	...
	inline bool operator==(const rb_tree_multimap_3w<Key, T, Compare, Allocator>& m1, const rb_tree_multimap_3w<Key, T, Compare, Allocator>& m2)
	...
	template<typename Key, typename T, typename Compare, typename Allocator>
	inline void swap(rb_tree_multimap_3w<Key, T, Compare, Allocator>& m1, rb_tree_multimap_3w<Key, T, Compare, Allocator>& m2)
    { m1.swap(m2); }
} //namespace grapenlp

#endif /*GRAPENLP_RB_TREE_MULTIMAP_3W_H*/
