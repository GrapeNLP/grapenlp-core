...
#ifndef GRAPENLP_LUTW_RTNO_H
#define GRAPENLP_LUTW_RTNO_H
...
namespace grapenlp
{
	...
	struct lutw_rtno
	{
		typedef typename ltw_rtno<InputIterator, unichar, Weight, ContextKey, ContextValue>::type type;
	private:
		lutw_rtno(){}
	};
	...
	struct lutwns_rtno
	{
		typedef typename ltwns_rtno<InputIterator, unichar, Weight, ContextKey, ContextValue>::type type;
	private:
		lutwns_rtno(){}
	};
} //namespace grapenlp

#endif /*GRAPENLP_LUTW_RTNO_H*/
