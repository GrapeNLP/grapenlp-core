...
namespace grapenlp
{
	...
	struct lutw_rtno
	{
		typedef typename ltw_rtno<InputIterator, unichar, Weight, ContextMask>::type type;
	private:
		lutw_rtno(){}
	};
	...
	struct lutwns_rtno
	{
		typedef typename ltwns_rtno<InputIterator, unichar, Weight, ContextMask>::type type;
	private:
		lutwns_rtno(){}
	};
} //namespace grapenlp
