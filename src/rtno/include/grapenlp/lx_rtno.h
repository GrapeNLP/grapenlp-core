...
namespace grapenlp
{
	...
	struct lx_rtno
	{
		typedef typename l_rtno<InputIterator, typename out_bound<Id>::const_ref, ContextMask>::type type;
	private:
		lx_rtno(){}
	};
	...
	struct lxns_rtno
	{
		typedef typename lns_rtno<InputIterator, typename out_bound<Id>::const_ref, ContextMask>::type type;
	private:
		lxns_rtno(){}
	};
} //namespace grapenlp
