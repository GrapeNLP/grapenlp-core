...
#ifndef GRAPE_LUA_TO_FPRTN_TOP_PARSER_H
#define GRAPE_LUA_TO_FPRTN_TOP_PARSER_H
...
namespace grape
{
	...
	private:
		...
		lua_to_fprtn_top_parser_impl_selector()
		{}
	};
} //namespace grape

#endif /*GRAPE_LUA_TO_FPRTN_TOP_PARSER_H*/
