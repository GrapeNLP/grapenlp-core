...
#ifndef GRAPE_TO_FPRTN_TOP_PARSER_H
#define GRAPE_TO_FPRTN_TOP_PARSER_H
...
//			static_cast<out_state&>(*result.first).set_mapped(out.initial_state.second.src_ref);
		...
		void operator()(const in_machine& grammar, bool hasnt_white_at_begin, bool hasnt_white_at_end, out_machine& out, weight w_min)
		{
#ifdef TRACE
...
#endif /*GRAPE_TO_FPRTN_TOP_PARSER_H*/
