...
#ifndef GRAPE_TO_FPRTN_ZPPS_PARSER_H
#define GRAPE_TO_FPRTN_ZPPS_PARSER_H
...
#include <grape/set_impl_selector.h>
...
namespace grape
{
	...
	struct to_fprtn_zpps_parser
	{
		...
		typedef typename output_fprtn_zpps<SourceRef, TagOutput, TagInput, execution_state_set_impl_choice>::type out_machine;
		...
		to_fprtn_zpps_parser(): input_match(), e(), dummy_x_p_key(NULL, NULL, NULL, NULL, 0), dummy_e_comp(NULL, NULL, NULL)
		{}
		to_fprtn_zpps_parser(match input_match_): input_match(input_match_), e(), dummy_x_p_key(NULL, NULL, NULL, NULL, 0), dummy_e_comp(NULL, NULL, NULL)
		{}
...
#endif /*GRAPE_TO_FPRTN_ZPPS_PARSER_H*/
