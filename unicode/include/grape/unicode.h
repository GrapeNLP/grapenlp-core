...
#include <grape/unichar.h>
#include <grape/file.h>
#include <grape/error.h>
#include <grape/functional.h>
#include <grape/u_uppercase_table.h>
#include <grape/u_lowercase_table.h>
#include <grape/u_touppercase_table.h>
#include <grape/u_tolowercase_table.h>
...
struct u_toupper: public std::unary_function<unichar, unichar>
{
	...
	{ return grape::u_touppercase_table[c]; }
};

struct u_tolower: public std::unary_function<unichar, unichar>
{
	unichar operator() (const unichar c) const
	{ return grape::u_tolowercase_table[c]; }
};
...
struct u_identity: public grape::identity<unichar>
{
	unichar operator() (const unichar c) const
	{ return c; }
};
...
{ return grape::uppercase_table[c]; }

inline bool u_is_lower(unichar c)
{ return grape::lowercase_table[c]; }

// End of Javier Sastre's functions
#endif /*GRAPE_UNICODE_H*/
