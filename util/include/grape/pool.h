...
namespace grape
{
	...
	struct array_fake_pool
	{
		...
		typedef grape::compare_3w<value_type, true> compare_3w;
	...
	struct trie_string_pool
	{
		...
		typedef grape::ref_compare_3w<base_type> compare_3w;
	...
	struct trie_string_ref_pool
	{
		...
		typedef std::less<value_type> less;
		typedef typename grape::compare_3w<value_type> compare_3w;
		typedef grape::deref<base_type> deref;
		typedef grape::ref<base_type> ptr;
