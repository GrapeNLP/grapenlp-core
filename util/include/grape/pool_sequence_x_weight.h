...
#ifndef GRAPE_POOL_SEQUENCE_X_WEIGHT_H
#define GRAPE_POOL_SEQUENCE_X_WEIGHT_H
...
namespace grape
{
	...
	struct pool_sequence_x_weight
	{
		...
		std::ptrdiff_t compare_3w(const value_type &psxw) const
		{
			...
			if (result)
				return result;
			return grape::compare_3w<ps_value_type>()(ps, psxw.ps);
		}
	};
...
#endif /*GRAPE_POOL_SEQUENCE_X_WEIGHT_H*/
